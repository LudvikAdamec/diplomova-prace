...
mergeHelp = function(mergeParams) {
  /**
...
mergeHelp.prototype.setTargetLayer = function(layer){
  this.targetLayer = layer;
}

mergeHelp.prototype.addTiles = function (tile) {
  this.tilesToMerge.push(tile);
};

mergeHelp.prototype.addFeatures = function (feature) {
  if(feature.geometry.type === "Polygon" || feature.geometry.type === "MultiPolygon"){
    this.featuresToMerge.push(feature);
  }
};

mergeHelp.prototype.merge = function () {
 ...
 */
mergeHelp.prototype.mergeTiles = function(){
 ...
 * @return {[type]}      [description]
 */
mergeHelp.prototype.mergeFeatures = function(features, featuresToMerge) {
  var this_ = this;
